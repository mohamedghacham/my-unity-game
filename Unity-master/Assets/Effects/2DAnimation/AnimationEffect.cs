...
public class AnimationEffect : MonoBehaviour {
	...
	void Start(){
		GetComponent<Renderer>().material.mainTextureScale = new Vector2(1/(float)tilesPerRow, 1/Mathf.Ceil((float)totalTiles/(float)tilesPerRow));
	}
	...
	void Update(){
		...
		GetComponent<Renderer>().material.mainTextureOffset = new Vector2(Xpos,Ypos);
